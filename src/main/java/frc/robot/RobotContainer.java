...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        new Trigger(() -> gyro.getAccelerationMagnitude() > SmartDashboard.getNumber("Impact Threshold", 1.5))
                .onTrue(Commands.run(() -> eyes.setLEDState(EyesSubsystem.LEDState.SCRAMBLED), eyes).withTimeout(2.0));

        new Trigger(() -> shooter.getShooterMode() == Shooter.ShooterMode.FIRE
                || shooter.getShooterMode() == Shooter.ShooterMode.OVERRIDE)
